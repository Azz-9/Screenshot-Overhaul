...
public class HideFromMapButton extends Button {
	...
	private void updateTooltip() {
		setTooltip(Tooltip.create(crossed ? Component.translatable("screenshot_utilities.hidden_from_worldmap") : Component.translatable("screenshot_utilities.hide_from_worldmap")));
	}
