...
public record Panorama(@NonNull UUID id, @NonNull File folder, @Nullable Screenshot[] faces,
	...
	public Panorama(@NonNull UUID id, @NonNull File folder, @Nullable Screenshot[] faces, @NonNull String pathRelativeToScreenshotDir) {
		this.id = id;
		this.folder = folder;
		this.faces = faces;
	...
	public static Optional<Screenshot> firstFace(Screenshot[] faces) {
		for (Screenshot face : faces) {
