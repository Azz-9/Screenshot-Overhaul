...
public final class UnsavedChangesOverlay extends AbstractWidget {
	...
	public UnsavedChangesOverlay(
		...
		cancelButton = Button.builder(
						Component.translatable("screenshot_utilities.settings.unsaved.cancel"),
						btn -> onCancel.run())
		...
		discardButton = Button.builder(
						Component.translatable("screenshot_utilities.settings.unsaved.discard"),
	...
	protected void extractWidgetRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float deltaTicks) {
		...
		// Title
		Component title = Component.translatable("screenshot_utilities.settings.unsaved.title");
		...
		// Body
		Component body = Component.translatable("screenshot_utilities.settings.unsaved.body");
	...
	public void updateWidgetNarration(@NonNull NarrationElementOutput output) {
		output.add(NarratedElementType.TITLE, Component.translatable("screenshot_utilities.settings.unsaved.title"));
	}
