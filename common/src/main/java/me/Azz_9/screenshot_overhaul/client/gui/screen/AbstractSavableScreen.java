...
import me.Azz_9.screenshot_overhaul.client.gui.components.config.UnsavedChangesOverlay;
...
public abstract class AbstractSavableScreen extends AbstractBackNavigableScreen {
	...
	public AbstractSavableScreen(@NonNull Component title) {
		super(title);
	}
	...
	protected final void init() {
		...
		cancelButton = Button.builder(
						Component.translatable("screenshot_overhaul.cancel"),
						btn -> onClose())
				.pos(startX, buttonsY)
		...
		saveButton = Button.builder(
						Component.translatable("screenshot_overhaul.save_and_quit"),
						btn -> onSavePressed())
