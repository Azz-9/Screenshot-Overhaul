...
public final class PathConfigOption extends AbstractConfigOption<Path> {
	...
	public enum SelectionMode {
		FILES_ONLY("screenshot_overhaul.settings.default_file_dialog_title.files_only"),
		DIRECTORIES_ONLY("screenshot_overhaul.settings.default_file_dialog_title.directories_only");
	...
	private PathConfigOption(@NonNull Builder builder) {
		super(
