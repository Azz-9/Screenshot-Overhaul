...
public class FavoriteButton extends Button {
	...
	protected FavoriteButton(int x, int y, int width, int height, @NonNull OnPress onPress, boolean filled) {
		super(x, y, width, height, Component.translatable("screenshot_overhaul.favorite"), onPress, DEFAULT_NARRATION);
		this.filled = filled;
	}
