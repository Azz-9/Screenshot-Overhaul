...
public class ScreenshotPreviewWidget extends AbstractWidget {
	...
	private void renderIcon(@NonNull GuiGraphicsExtractor graphics, @NonNull Identifier icon, int x, int y, int areaW, int areaH, float alpha) {
	...
	private void renderLabel(@NonNull GuiGraphicsExtractor graphics, int x, int y, int areaW, int areaH, @NonNull Component text, float alpha) {
		int iconSize = Math.min(areaW, areaH) / 3;
